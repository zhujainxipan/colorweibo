 ...
 * Date: 2015/5/2
 */
public class FromMyCommentListAdapter extends BaseAdapter {
    private Context context;
    private List<Comment> list;

    public FromMyCommentListAdapter(Context context, List<Comment> list) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_frommymsgcomment, null);
